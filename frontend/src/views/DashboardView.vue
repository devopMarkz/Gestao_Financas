  ...
  <div class="dashboard-wrapper">
    ...
    <div class="dashboard-container">
      ...
      <div class="acoes-futuras">
        ...
        <button class="acao-btn" @click="irParaGraficoFinanceiro">
          <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <line x1="4" y1="20" x2="4" y2="10" stroke="currentColor" stroke-width="2"/>
            <line x1="10" y1="20" x2="10" y2="6" stroke="currentColor" stroke-width="2"/>
            <line x1="16" y1="20" x2="16" y2="14" stroke="currentColor" stroke-width="2"/>
            <line x1="22" y1="20" x2="22" y2="2" stroke="currentColor" stroke-width="2"/>
          </svg>
         Gráfico Financeiro
        </button>
...
export default {
  ...
  methods: {
    ...
    irParaGraficoFinanceiro(){
      this.$router.push('/grafico-analise')
    }
  },
